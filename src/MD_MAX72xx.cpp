...
// not operate correctly.
{
  ...
  switch (_mod)
  {
    ...
    case ICSTATION_HW: _hwDigRows = true;  _hwRevCols = false;  _hwRevRows = false;  break; // tested MC 9 March 2014
//  original case ICSTATION_HW: _hwDigRows = true;  _hwRevCols = true;  _hwRevRows = true;  break; // tested MC 9 March 2014
//  original   case FC16_HW:      _hwDigRows = true;  _hwRevCols = false; _hwRevRows = false; break; // tested MC 23 Feb 2015
    case FC16_HW:      _hwDigRows = true;  _hwRevCols = true; _hwRevRows = true; break; // tested MC 23 Feb 2015
